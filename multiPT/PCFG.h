...
void serializePT(const PT& pt, std::vector<int>& data);
void deserializePT(PT& pt, const std::vector<int>& data);
void serializePTs(const std::vector<PT>& pts, std::vector<int>& data);
void deserializePTs(std::vector<PT>& pts, const std::vector<int>& data);
